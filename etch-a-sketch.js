...
function main() {
  ...
  const colourPickerWrapper = document.querySelector(".colour-picker-wrapper");
  console.log(colourPickerWrapper);
  let colour = "black";
  colourPickerWrapper.style.backgroundColor = colour;
  colourPickerWrapper.style.border = "5px solid black";
  ...
  colourPicker.onchange = (e) => {
    ...
    colourPickerWrapper.style.backgroundColor = colourPicker.value;
  };
